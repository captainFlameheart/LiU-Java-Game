...
public class PhysicsWorldDrawer extends JComponent
{
     ...
     */
    public PhysicsWorldDrawer(final Interval startToEndX, final Interval startToEndY, final BodyDrawer... bodyDrawers) {
	this.startToEndX = startToEndX;
	this.startToEndY = startToEndY;
	this.bodyDrawers = new ArrayList<>(Arrays.asList(bodyDrawers));
    }

    public void add(final BodyDrawer bodyDrawer) {
	bodyDrawers.add(bodyDrawer);
    }
